...
// here we use ERC20.sol because our Exchange needs to mint and create Crypto Dev LP tokens
contract Exchange is ERC20 {

    // takes the address of the _CryptoDevToken that you deployed in the ICO tutorial as an input param
    ...
    constructor(address _CryptoDevtoken) ERC20("CryptoDev LP Token", "CDLP") {
        ...
        // assigns the value to the input param to the cryptoDevTokenAddress variable
        cryptoDevTokenAddress = _CryptoDevtoken;
    }

    /**
     * create a function to get reserves of the Eth and Crypto Dev tokens held by the contract.
     * since the Crypto Dev Token contract that we deployed in the ICO is an ERC20, So we can just call the balanceOf to check the balance of CryptoDev Tokens that the contract holds.
    ...
    */
    ...
    /**
     * addLiquidity function would add liquidity in the form of ETH and Crypto Dev tokens to our contract
    ...
    */
    ...
    /**
     * removeLiquidity function for removing liquidity from the contract.
    ...
    */
    ...
    /**
     * lets implement the swap functionality
    * @dev Returns the amount Eth/Crypto Dev tokens that would be returned to the user
    * in the swap
    */
    ...
    /**
     * implement a function to swap ETH for Crypto Dev tokens
...
// Exchange Contract Address: 0x7356E6c44DEDf5a475b72336038C021B56D5b241